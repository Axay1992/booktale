...
class SiteListEndPoints {
  ...
  static const String siteList = "${property}site?size=10";
  static const String bookingAdd = "${property}booking";
  static const String siteDetail = "${property}site/detail";
  ...
  //"$siteList&size=10&sortField=createdOn&sortOrder=-1&search=raj";
}
